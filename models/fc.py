...
class Model(nn.Module):
    ...
    """
        ...
        ball ->                        FC ->
        left_team ->  FC -> conv1d ->  FC -> FC(Concat) ->   FC -> FC -> FC -> Policy(Dir)
    ...
    def __init__(self, arg_dict, device=None):
        ...
        self.fc_cat2 = nn.Linear(arg_dict["lstm_size"], arg_dict["lstm_size"])
        ...
        self.norm_cat2 = nn.LayerNorm(arg_dict["lstm_size"])
    ...
    def forward(self, state_dict):
        ...
        h_out = copy.deepcopy(h_in)
        out = F.relu((self.norm_cat2(self.fc_cat2(cat))))
